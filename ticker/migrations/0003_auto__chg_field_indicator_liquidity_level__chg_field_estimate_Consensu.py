...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Indicator.liquidity_level'
        db.alter_column(u'ticker_indicator', 'liquidity_level', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Estimate.Consensus_present'
        db.alter_column(u'ticker_estimate', 'Consensus_present', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Estimate.Consensus_1_month_ago'
        db.alter_column(u'ticker_estimate', 'Consensus_1_month_ago', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Estimate.Average_Recommendation'
        db.alter_column(u'ticker_estimate', 'Average_Recommendation', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Estimate.Consensus_3_month_ago'
        db.alter_column(u'ticker_estimate', 'Consensus_3_month_ago', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Indicator.liquidity_level'
        db.alter_column(u'ticker_indicator', 'liquidity_level', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))

        # Changing field 'Estimate.Consensus_present'
        db.alter_column(u'ticker_estimate', 'Consensus_present', self.gf('django.db.models.fields.CharField')(default=None, max_length=10))

        # Changing field 'Estimate.Consensus_1_month_ago'
        db.alter_column(u'ticker_estimate', 'Consensus_1_month_ago', self.gf('django.db.models.fields.CharField')(default=None, max_length=10))

        # Changing field 'Estimate.Average_Recommendation'
        db.alter_column(u'ticker_estimate', 'Average_Recommendation', self.gf('django.db.models.fields.CharField')(default=None, max_length=10))

        # Changing field 'Estimate.Consensus_3_month_ago'
        db.alter_column(u'ticker_estimate', 'Consensus_3_month_ago', self.gf('django.db.models.fields.CharField')(default=None, max_length=10))
